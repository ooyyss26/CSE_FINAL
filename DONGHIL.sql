...
CREATE TABLE `orders_has_products` (
  ...
  KEY `fk_orders_has_products_orders_idx` (`orders_idorders`),
  CONSTRAINT `fk_orders_has_products_orders` FOREIGN KEY (`orders_idorders`) REFERENCES `orders` (`idorders`),
...
INSERT INTO `products` VALUES (11,'laptop',45000.00),(12,'mouse',1000.00),(13,'keyboard',2300.00),(14,'monitor',15000.00),
(15,'headphones',5000.00),(16,'webcam',3000.00),(17,'microphone',2500.00),(18,'speakers',4000.00),(19,'router',8000.00),
(20,'hard drive',12000.00),(21,'SSD',18000.00),(22,'RAM',6000.00),(23,'graphics card',35000.00),(24,'motherboard',10000.00),
(25,'power supply',5000.00),(26,'case',3000.00),(27,'cooler',2000.00),(28,'mouse pad',500.00),(29,'USB drive',1000.00),
(30,'external HDD',15000.00);
...
-- Dump completed on 2025-11-17 13:49:04
